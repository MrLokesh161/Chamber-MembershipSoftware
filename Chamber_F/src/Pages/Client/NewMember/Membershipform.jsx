...
const Membershipform = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    profession3: "Software Developer",
  ...
  const [legalInfo, setLegalInfo] = useState("Your legal information here.");
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      const response = await axios.post(
        "http://127.0.0.1:8000/membershipform/",
        formData,
        {
          headers: {
            ...
            <div className="flex flex-col mb-4">
              ...
              {formData.constitution.individual && (
                <div className="ml-[8.5rem] mb-4">
                  ...
                  {formData.profession.map((profession, index) => (
                    <div
